...
namespace FSM
{
    ...
    public abstract class PlayerState : State<Player>
    {
        ...
        public PlayerState(Player owner, StateMachine<Player> stateMachine) : base(owner, stateMachine)
        {
    ...
    public abstract class MonsterState : State<Monster>
    {
        ...
        public MonsterState(Monster owner, StateMachine <Monster>stateMachine) : base(owner, stateMachine)
        {
